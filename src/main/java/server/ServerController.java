...
public class ServerController {
    ...
    public FractalTreeResponse retrieve_tree_data(
        ...
        return new FractalTreeResponse(
            bikeCo2,
            vegmealsCO2,
            localproduceCO2,
            publicCO2,
    ...
    public PaperRecyclingResponse paperRecycling(
        ...
        double paperrecyclingCO2 = DatabaseHandler.increaseFeatureCounter(
            paperRecyclingRequest.getUid(),
    ...
    public PlasticRecyclingResponse plasticRecycling(
        ...
        double plasticrecyclingCO2 = DatabaseHandler.increaseFeatureCounter(
            plasticRecyclingRequest.getUid(),
