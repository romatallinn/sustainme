...
public class ApiRequest {
        ...
        public static void main(String[] args) throws Exception {
            ...
            rd.close();
            System.out.println(result.toString().split("result_motor_vehicles_direct>")[1].substring(0,8));*/
        }
        ...
        public static double requestBike(String distance) throws Exception {
            ...
            rd.close();
            double test = Double.parseDouble(result.toString().split("result_motor_vehicles_direct>")[1].substring(0,8));
            System.out.println();
            return test;
        }
